...
#can add an option to re-play the game or quit
#could try add a bit more funk e.g. something more exciting, visuals etc
import random,time
...
def incorrect_guess(score,next_card):
    print(f'The next card is {next_card[0]}')
    short_pause()
    message = print(f'Sorry, that was incorrect! Your final score is {score}')
    return message
